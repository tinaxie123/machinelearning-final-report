        ...
        for m in range(self.n_estimators):
            ...
            for k in range(self.n_classes_):
                if self.subsample < 1.0:
                    ...
                    X_sub = X[indices]
                    residuals_sub = residuals[indices, k]
                else:
                    X_sub = X
                    residuals_sub = residuals[:, k]
...
def main():
    print("GBDT Classifier Experiment")
    ...
    print(f"\nModel saved to: models/gbdt_classifier.pkl")
    print(f"Results saved to: models/gbdt_results.pkl")
